            ...
            {[
              {
                ...
                body: 'A storyboard begins with one person, in one situation, doing one thing. Not "a user wants to plan meals" — "a parent, opening the fridge at 5pm on a Wednesday, with no idea what to cook." The more specific the scenario, the harder it is to hide behind generality in later frames.',
              },
              {
                n: '02',
