...
const CONTENT: Record<Tab, React.ReactNode> = {
  traditional: (
    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
      <p className="mb-5">
        Leadership convened a half-day session. Before placing anything on the matrix, they agreed on concrete criteria for the two axes: what counted as an &ldquo;existing&rdquo; versus a &ldquo;new&rdquo; market, and an &ldquo;existing&rdquo; versus a &ldquo;new&rdquo; offering. Then they plotted all eleven initiatives &mdash; and crucially mapped the actual budget and headcount behind each, not just the project names.
      </p>
      <p className="mb-5">
        The picture was stark. Nine of the eleven initiatives, and roughly 88 percent of the innovation budget, sat in the core: faster chargers, a slightly thinner model, a cost-reduced variant. One initiative was adjacent. One was nominally transformational, but it had two people and almost no funding &mdash; a &ldquo;moonshot&rdquo; in name that was being quietly starved.
      </p>
      <p className="mb-5">
  ...
  ai: (
    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
      <p className="mb-5">
        The same company ran the same exercise with AI assistance layered onto the analysis. AI-assisted analytics modeled the expected returns of the nine core initiatives quickly and rigorously &mdash; work that would have taken the strategy team weeks. For the adjacent bet, AI-assisted market sizing generated useful scenario estimates that sharpened the opportunity picture.
      </p>
      <p className="mb-5">
