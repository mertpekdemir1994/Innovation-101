...
const CONTENT: Record<Tab, React.ReactNode> = {
  ...
  ai: (
    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
      ...
      <p className="mb-5">
        The AI analysis strengthened the core picture: it could forecast the incremental returns of the charger and thin-model projects with real precision, and it confirmed that several core bets had strong, quantifiable near-term returns. For a skeptical board, the depth and speed of that analysis was genuinely convincing.
      </p>
      <p className="mb-5">
