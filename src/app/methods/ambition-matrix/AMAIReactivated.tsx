    ...
    <div>
      ...
      <div className="w-full flex justify-center mb-12 select-none" aria-hidden="true">
        <svg viewBox="0 0 560 450" width="100%" style={{ maxWidth: 'var(--width-illustration)', overflow: 'visible' }}>
          ...
          {/* Axis labels */}
          <text x={GX} y={GB + 22} textAnchor="start" fontSize="9" fontFamily="var(--font-mono)" letterSpacing="0.08em" fill="rgba(255,255,255,0.6)" style={{ userSelect: 'none' }}>EXISTING</text>
          <text x={GR} y={GB + 22} textAnchor="end"   fontSize="9" fontFamily="var(--font-mono)" letterSpacing="0.08em" fill="rgba(255,255,255,0.6)" style={{ userSelect: 'none' }}>NEW</text>
          <text x={MX} y={GB + 40} textAnchor="middle" fontSize="9" fontFamily="var(--font-mono)" letterSpacing="0.08em" fill="rgba(255,255,255,0.57)" style={{ userSelect: 'none' }}>MARKET / CUSTOMER →</text>
          <text x={GX - 8} y={GB}      textAnchor="end" fontSize="9" fontFamily="var(--font-mono)" letterSpacing="0.08em" fill="rgba(255,255,255,0.6)" style={{ userSelect: 'none' }}>EXISTING</text>
          <text x={GX - 8} y={GY + 6} textAnchor="end" fontSize="9" fontFamily="var(--font-mono)" letterSpacing="0.08em" fill="rgba(255,255,255,0.6)" style={{ userSelect: 'none' }}>NEW</text>
          <text transform={`translate(28, ${MY}) rotate(-90)`} textAnchor="middle" fontSize="9" fontFamily="var(--font-mono)" letterSpacing="0.08em" fill="rgba(255,255,255,0.57)" style={{ userSelect: 'none' }}>↑ OFFERING / PRODUCT</text>
