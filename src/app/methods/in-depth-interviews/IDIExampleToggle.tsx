...
const CONTENT: Record<Tab, React.ReactNode> = {
  traditional: (
    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
      ...
      <p className="mb-5">
        The facilitator resisted asking &ldquo;were the sessions too long?&rdquo; &mdash; which would have led the witness toward the company&rsquo;s assumption. Instead she asked people to walk her through the last time they opened the app and what was happening around them. One participant, describing the moment she deleted it, went quiet, then said: &ldquo;I felt like I was failing at relaxing.&rdquo;
      </p>
      <p className="mb-5">
        The facilitator said nothing, letting the silence sit, and the participant continued &mdash; explaining that she could never tell whether she was meditating &ldquo;correctly,&rdquo; and that uncertainty produced anxiety, the exact opposite of what she had come for.
      </p>
      <p className="mb-5">
        The note-taker flagged that this same emotional note &mdash; a feeling of doing it wrong &mdash; appeared in different words across many of the interviews, often in a lowered voice or after a pause. It was never stated as &ldquo;the sessions are too long.&rdquo; It was always something closer to shame.
      </p>
      <div
      ...
      >
        ...
        <p style={{ fontStyle: 'italic', color: 'var(--color-neutral-800)' }}>
          People were not quitting because sessions were long. They were quitting because the experience made them feel like they were failing. That redirected the redesign away from shorter sessions and toward reassurance &mdash; removing any sense of a right or wrong way to do it. The breakthrough came from a human catching a quiet, almost-unspoken feeling and choosing to follow it.
        </p>
      </div>
    </div>
  ),
  ai: (
    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
      <p className="mb-5">
        The same team ran the same question using AI-assisted interviewing. An AI moderator (an Outset.io-style tool) conducted structured conversations with 200 lapsed users in parallel over two days &mdash; far beyond what the human team could have scheduled. AI transcription captured every word, and AI analysis surfaced candidate themes across all 200 transcripts within minutes.
      </p>
      <p className="mb-5">
        The scale paid off in ways the traditional study could not match. The theme of &ldquo;uncertainty about doing it right&rdquo; appeared at measurable frequency across a large sample, turning what was a vivid human anecdote in the traditional study into a quantified, hard-to-dismiss pattern. For convincing a skeptical leadership team, that breadth was powerful: not one memorable quote, but a clear signal across hundreds of people.
      </p>
      <p className="mb-5">
        But the tradeoff showed too. The AI moderator, following its guide competently, did not pause on the participant who went quiet before admitting she felt like a failure &mdash; because it had no instinct that the silence mattered. The phrase &ldquo;I felt like I was failing at relaxing,&rdquo; the single line that crystallized the whole insight in the traditional study, did not emerge with the same emotional force. The AI captured the theme but not the texture.
      </p>
      <div
        className="rounded-lg p-5 mt-6"
      ...
      >
        ...
        <p style={{ fontStyle: 'italic', color: 'var(--color-neutral-800)' }}>
          The AI run produced breadth, speed, and quantified confidence the human run could not. The human run produced one piece of un-rationalized human truth the AI run blurred. The strongest version of this study uses both &mdash; AI for scale and pattern, a handful of human-run interviews to catch the texture and the surprise. That is exactly how the best teams now combine them.
        </p>
      </div>
    </div>
  ),
