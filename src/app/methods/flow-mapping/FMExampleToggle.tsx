          ...
          >
            ...
            <div className="rounded-lg p-5" style={{ border: `1px solid ${TEAL}0.15)` }}>
              ...
              <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
                ...
                category of customer complaints about claims that had simply stopped moving — complaints
          ...
          >
            ...
            <div className="rounded-lg p-5"
              ...
              <div className="rounded p-3"
                ...
                <p style={{ fontSize: 'var(--text-xs)', color: 'var(--color-neutral-600)', lineHeight: 'var(--leading-relaxed)' }}>
                  ...
                  plausible, it simply handed the organization its own story back — with the accreted mess,
            ...
            <div className="rounded-lg p-5"
              ...
              <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
                ...
                flow is, quite literally, the finding. The fifteen years of accreted complexity that explains
