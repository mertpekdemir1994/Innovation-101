        ...
        <Container prose>
          <div className="py-20">
            ...
            <div className="flex flex-col gap-5">
              <Body>
                SWOT is a four-quadrant view of a situation: your STRENGTHS and WEAKNESSES, which are internal and largely within your control, and your OPPORTUNITIES and THREATS, which are external and are not. Two axes give the four boxes their meaning: internal versus external, and helpful versus harmful. Those axes matter more than they look, because the most common way a SWOT goes wrong at the first step is miscategorizing: dropping an external market trend into a &ldquo;Strength&rdquo; box, or listing an aspiration as an opportunity. A strength is something you HAVE; an opportunity is something in the WORLD. Keep the axes honest and the rest of the method has a chance.
              </Body>
              <Body>
          ...
          <div className="py-20">
            ...
            <div className="flex flex-col gap-7 mt-2">
              {[
                ...
                { n: '03', title: 'Be honest about weaknesses and threats.', body: 'The two harmful quadrants are where the value is, and where teams flinch. A diplomatic weakness list makes the two most important crossings (W×T and W×O) impossible. Make it safe to be blunt, or do not bother.' },
          ...
          <div className="py-20">
            ...
            <ul className="flex flex-col gap-3 mb-10">
              {[
                ...
                'The weakness and threat quadrants are honest, not diplomatic.',
      ...
      <LightSection>
        <Container prose>
          <div className="py-20">
            ...
            <SectionHeadingLight>Practical considerations for a session that works.</SectionHeadingLight>
              ...
              {[
                {
                  ...
                  year: '2011',
                  description: 'For what competitive strategy requires, and why a situational scan is only ever a starting point.',
                },
                {
