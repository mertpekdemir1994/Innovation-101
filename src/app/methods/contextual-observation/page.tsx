...
const RELATED_METHODS: RelatedMethod[] = [
  ...
  },
  {
    ...
    rel: 'Empathy maps are most powerful when built from direct observational data rather than assumed behavior. Contextual observation provides the raw material for the says, thinks, does, and feels quadrants — especially the does quadrant, which is nearly impossible to fill accurately from interviews alone.',
  },
  {
      ...
      <DarkSection>
        <Container>
          <div className="py-20 md:py-28">
            ...
            >
              Watching people in their natural environment to see what they actually do &mdash; not what they say they do, and not what they think they do.
            </p>
        ...
        <Container prose>
          <div className="py-20">
            ...
            <div className="flex flex-col gap-5">
              <Body>
                Contextual observation &mdash; also called ethnographic research, contextual inquiry, or field research &mdash; involves
              ...
              <Body>
                ...
                not reported behavior. It is especially powerful when the gap between the two is large &mdash; which it reliably
          ...
          <div className="py-20">
            ...
            >
              <p style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-600)', lineHeight: 'var(--leading-relaxed)', fontStyle: 'italic' }}>
                ...
                poorly &mdash; rushing through sessions, leading participants, not documenting the environment, failing to debrief
                immediately &mdash; it produces impressions, not data.
              </p>
            </div>
          </div>
        </Container>
        ...
        <Container>
          <div className="py-20">
            ...
            <p
              ...
              style={{ fontSize: 'var(--text-base)', color: 'rgba(255,255,255,0.48)' }}
            >
              Toggle between modes to see what AI can analyse in a digital context &mdash; and what the camera frame
      ...
      <LightSection>
        <Container prose>
          <div className="py-20">
            ...
            <SectionHeadingLight>The same scenario. Two approaches &mdash; one finds the shoebox, one optimises the software.</SectionHeadingLight>
            <p
              className="mb-10"
            ...
            >
              ...
              Toggle between the contextual observation approach and a hypothetical AI-analysis approach to see what each reveals &mdash;
        ...
        <Container prose>
          <div className="py-20">
            ...
            >
              ...
              framework &mdash; the moments when a team is trying to understand the problem before solving it.
            </p>
