...
const CONTENT: Record<Tab, React.ReactNode> = {
  traditional: (
    <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-neutral-700)', lineHeight: 'var(--leading-relaxed)' }}>
      <p className="mb-5">
        The team ran fifteen in-depth interviews with a deliberately varied set of people who struggled with budgeting &mdash; different ages, different incomes, different relationships with money. They synthesized the research into four personas covering the real range they found.
      </p>
      <p className="mb-5">
        The interviews broke the founding assumption. Yes, one persona matched their imagined user: the Optimizer, a confident power user who wanted control and features. But the most common and most underserved type was almost the opposite. The team came to call her the Avoider: someone whose relationship with money was anxious and shame-tinged, who did not want more data and control but <em>less</em>, who wanted to feel reassured rather than empowered. For the Avoider, the team&rsquo;s planned feature-rich, dashboard-heavy product was actively repellent &mdash; it made the anxiety worse.
      </p>
      <p className="mb-5">
        That persona appeared in six of the fifteen interviews. The team would never have designed for her &mdash; or even imagined her &mdash; without talking to real people. And designing for her (calm, reassuring, minimal, judgment-free) rather than only for the confident Optimizer changed the entire direction of the product.
      </p>
...
export default function PAExampleToggle() {
  ...
  return (
    <div>
      ...
      {/* Tab bar */}
      <div className="flex gap-2 mb-8" role="tablist" aria-label="Persona-building approach">
        {TABS.map(({ id, label }) => {
