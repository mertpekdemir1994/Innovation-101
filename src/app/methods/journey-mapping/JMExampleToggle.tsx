...
const CONTENT: Record<Tab, {
  ...
  ai: {
    ...
    steps: [
      'AI sentiment analysis draws an emotion line from the data at population scale. The breadth matters: the map confirms patterns across thousands of patients, not just a handful. Departments that previously dismissed small-sample research now see quantified evidence that is harder to ignore.',
