          ...
          <motion.div key="traditional"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="border rounded-lg p-5 border-amber-200 bg-amber-50">
                <p className="text-[10px] font-semibold uppercase tracking-widest text-amber-700 mb-3">Gaps Exposed</p>
                <div className="space-y-3">
                  <div>
          ...
          <motion.div key="ai"
            ...
            <div className="border rounded-lg p-5" style={{ borderColor: `${INDIGO}0.22)` }}>
              <div className="flex items-center justify-between mb-4">
                <p className="text-[10px] font-semibold uppercase tracking-widest"
                  style={{ color: `${INDIGO}0.90)` }}>AI-Generated Canvas</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="rounded p-3" style={{ background: `${INDIGO}0.04)` }}>
                  <p className="text-[9px] font-semibold uppercase tracking-wider mb-2"
                    style={{ color: `${INDIGO}0.70)` }}>AI Customer Profile (generated)</p>
                  {[
                ...
                <div className="rounded p-3" style={{ background: `${INDIGO}0.04)` }}>
                  <p className="text-[9px] font-semibold uppercase tracking-wider mb-2"
                    style={{ color: `${INDIGO}0.70)` }}>AI-Drawn Connections</p>
                  {[
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border rounded-lg p-5 border-green-200 bg-green-50">
                <p className="text-[10px] font-semibold uppercase tracking-widest text-green-700 mb-3">What AI Got Right</p>
