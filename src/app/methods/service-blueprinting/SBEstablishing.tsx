...
const CA_Y = 50,  CA_H = 42   // Customer Actions: 50..92
const FS_Y = 94,  FS_H = 42   // Frontstage:       94..136
const LOV_LINE_Y = 143         // Line of Visibility
const BS_Y = 150, BS_H = 42   // Backstage:        150..192
const SP_Y = 194, SP_H = 42   // Support Processes: 194..236
const SVG_H = 244
