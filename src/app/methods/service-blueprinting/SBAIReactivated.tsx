...
// (hanging baseline), the row of AI-overlay/marker text sits well below
// it so an 11pt label and an 11pt second line never touch.
const LABEL_DY = 6
const ITEM_DY  = 32
...
const WORKAROUND_Y = BS_Y + ITEM_DY
              ...
              <button key={label}
                ...
                style={{
                  background: isActive
                    ...
                    : 'transparent',
                  color: isActive ? (isAI ? '#fff' : '#111') : 'rgba(255,255,255,0.50)',
                }}
      ...
      <div className="w-full select-none mb-10" aria-hidden="true">
        <svg viewBox={`0 0 ${SVG_W} ${SVG_H}`} width="100%" style={{ maxWidth: 'var(--width-illustration)', display: 'block', overflow: 'visible' }}>
          ...
          {/* Undocumented workaround marker:
              visible (amber/orange) in human mode; "AI MISSES THIS" appears
              beside it, at the same baseline, in AI mode */}
