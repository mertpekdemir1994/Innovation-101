...
const CONTENT: Record<Tab, {
  ...
  ai: {
    ...
    steps: [
      ...
      'But the decisive insight comes through only faintly. According to the process documentation, the handoff between the loan officer and underwriting is a defined step — so on the AI\'s blueprint it looks fine. The delay lives in the gap between what the document says and what actually happens. Because no system logs the unowned wait as a discrete failure (the application is simply "in process"), the AI\'s view does not flag it as the problem. The documented handoff looks healthy; only the undocumented reality is broken.',
