...
const VERSIONS = [
  ...
  },
  {
    ...
    limitation:
      'Assumes product teams with enough autonomy to conduct their own research. Less directly applicable to teams working under heavy feature-request governance or with very long sales cycles.',
  },
  {
    year: 'Corp.',
