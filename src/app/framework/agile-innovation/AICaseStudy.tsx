...
const LESSONS = [
  ...
  },
  {
    ...
    detail:
      'One of Brightwater\'s other two squads, after a Discovery Sprint, found that the market assumption beneath its initiative was simply false and deliberately stopped. That stop, made on evidence after weeks rather than 18 months, was cited by the CIO as the clearest proof the new way of working was succeeding.',
  },
  {
    n: '04',
