...
const VERSIONS = [
  {
    ...
    limitation:
      'The Manifesto is a philosophy, not an implementation guide. It tells you what to value but not how to organize a team, run a planning session, or coordinate ten teams working on the same product. The practitioner community filled that gap in very different ways, producing the family of frameworks below.',
  },
  {
    year: '1995 / 2001',
    name: 'Scrum',
