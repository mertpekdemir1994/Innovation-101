    ...
    <>
      ...
      <LightSection>
        <Container className="py-space-12">
          ...
          <ScrollReveal>
            <div
              className="max-w-prose mx-auto rounded-xl px-space-6 py-space-5 mb-space-10"
          ...
          <ScrollReveal delay={0.05}>
            ...
            <p className="text-base text-neutral-500 mb-space-10 max-w-prose mx-auto px-6 md:px-8">
